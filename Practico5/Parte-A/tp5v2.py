...
#TRASLACION
M_2 = np.float32([[math.cos(a),math.sin(a),x],[-math.sin(a),math.cos(a),y]])
...
dst_b = cv2.warpAffine(b,M_2,(cols,rows)) 
dst_g = cv2.warpAffine(g,M_2,(cols,rows)) 
dst_r = cv2.warpAffine(r,M_2,(cols,rows)) 
...
img = cv2.merge((dst_b,dst_g,dst_r))
